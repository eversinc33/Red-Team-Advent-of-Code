...
proc injector[I, T](shellcode: array[I,T]): void =
  ...
  # call VirtualAllocEx to make space in memory
  ...
  # call WriteProcessMemory to inject shellcode to memory
  ...
  # call CreateRemoteThread to execute thread with shellcode
