...
8 | Mail generator | Write a script that parses an Email-template and fills in Names, Job Roles and the phishing URL and sends out a mail to the victims email address.
